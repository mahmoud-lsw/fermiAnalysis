...
#bashCommand = "ls -1 "+spacecraftFolder +"/*weekly*.fits > spacelist.list"
#os.system(bashCommand)
#spacecraftFile='@spacelist.list'

spacecraftFolder='./spacecraft'						# This is how I find the spacecraft file
while not os.path.isdir(spacecraftFolder):
	spacecraftFolder='../'+spacecraftFolder
spacecraftFile=spacecraftFolder+'/spacecraft.fits'
...
file.close()
name_type= 'LAT'  ############################# # Usually LAT
if (float(eMin/1000.0)).is_integer():                                                  name_energy=str(int(eMin/1000.0))+'-'+str(int(eMax/1000.0))+'GeV' 
else:
