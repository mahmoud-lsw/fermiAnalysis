...
% Just do a ctrl-f from minBins and '% ME %'
...
minBins=1;  % Used to be 10, this may cause problems
maxBins=1000;
binFactorX = 1;
binFactorY = 1;
...
%%%%%%%%%%%%% ME %%%%%%%%%%%%%%%%%%
% To return to original, remove this chunk
if binFactorX~=1
    binWidthX=binFactorX;
end

if binFactorY~=1
    binWidthY=binFactorY;
end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
