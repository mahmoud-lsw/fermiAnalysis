...
for i=1:rows
    ...
    angularDist(i,3)=angDist2(photonsAroundSource(1,4:5),photonsAroundSource(i,4:5));
    angularDist(i,4)=angDist2(photonsAroundSource(1,2:3),photonsAroundSource(i,2:3));

    % Is rad the problem?
    angularDist(i,5)=angDist2NORAD(photonsAroundSource(1,4:5),photonsAroundSource(i,4:5));
    angularDist(i,6)=angDist2NORAD(photonsAroundSource(1,2:3),photonsAroundSource(i,2:3));
